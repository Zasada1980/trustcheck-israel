      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white font-bold text-lg mb-4">TrustCheck Israel</h3>
            <p className="text-sm mb-4" dir="rtl">
              פלטפורמה לבדיקת אמינות עסקים בישראל. בדוק לפני שאתה משלם - הגן על המשפחה שלך.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/" className="hover:text-white transition-colors">בדיקת עסק</Link></li>
          ...
          {/* Legal */}
          <div>
            <h4 className="text-white font-semibold mb-4">מידע משפטי</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/cookies" className="hover:text-white transition-colors">מדיניות עוגיות</Link></li>
              <li><Link href="/disclaimer" className="hover:text-white transition-colors">הצהרת אחריות</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">
            © {currentYear} TrustCheck Israel. All rights reserved.
          </p>
