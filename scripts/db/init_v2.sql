...
CREATE TABLE IF NOT EXISTS companies_registry (
    ...
    last_annual_report_year NUMERIC,                     -- שנה אחרונה של דוח שנתי (column 12)
    ...
    address_zipcode NUMERIC,                             -- מיקוד (column 16)
    ...
    -- Codes (columns 21-29)
    status_code NUMERIC,                                 -- קוד סטטוס חברה (column 21)
    company_type_code NUMERIC,                           -- קוד סוג חברה (column 22)
    company_classification_code NUMERIC,                 -- קוד סיווג חברה (column 23)
    purpose_code NUMERIC,                                -- קוד מטרת החברה (column 24)
    limitations_code NUMERIC,                            -- קוד מגבלה (column 25)
    violations_code NUMERIC,                             -- קוד חברה מפרה (column 26)
    city_code NUMERIC,                                   -- קוד ישוב (column 27)
    street_code NUMERIC,                                 -- קוד רחוב (column 28)
    country_code NUMERIC,                                -- קוד מדינה (column 29)
